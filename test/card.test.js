      ...
      return chai
        ...
        .then(response => {
          ...
          expect(item.description)
            .to
            .equal(response.description);
          expect(item.hours)
            .to
            .equal(response.hours);
        });
    });
      ...
      return chai
        ...
        .then(response => {
          ...
          expect(response.body)
            ...
            .be
            .an('object');
          expect(response.body.tips.length)
            .to
            .equal(1);
        });
    });
